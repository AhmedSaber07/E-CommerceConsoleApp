...
--3- Delete Category
----------------------------------
CREATE OR ALTER PROCEDURE sp_DeleteCategory @Name NVARCHAR(50)
WITH ENCRYPTION
AS
...
--7- Create Product
----------------------------------
CREATE OR ALTER PROCEDURE sp_CreateProduct @Name NVARCHAR(50) ,@Quantity int,@Price Money,@Description NVARCHAR(50),@CategoryId INT
WITH ENCRYPTION
AS
...
--8- Update Product
----------------------------------
CREATE OR ALTER PROCEDURE sp_UpdateProduct @Name NVARCHAR(50) ,@Quantity int,@Price Money,@Description NVARCHAR(50),@CategoryId INT
WITH ENCRYPTION
AS
	Update Products
